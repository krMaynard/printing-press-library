...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "naver-privacy-pp-cli",
		Short: `Naver Privacy CLI — Naver's transparency-report series — Korea's first, published since 2015 — as tidy per-category statistics instead of a…`,
		Long: `Naver Privacy CLI — Naver's transparency-report series — Korea's first, published since 2015 — as tidy per-category statistics instead of a…
...
Health check: run 'naver-privacy-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("naver-privacy-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'naver-privacy-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelStatisticsCmd(flags))
	rootCmd.AddCommand(newNovelSummariesCmd(flags))
	rootCmd.AddCommand(newNovelWhitepapersCmd(flags))
