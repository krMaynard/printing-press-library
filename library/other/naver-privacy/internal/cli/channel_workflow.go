...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  naver-privacy-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  naver-privacy-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  naver-privacy-pp-cli workflow status

  # Show status as JSON
  naver-privacy-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("naver-privacy-pp-cli")
			}
