...
Resource scoping:
  ...
  naver-privacy-pp-cli sync

  # Sync specific resources only
  naver-privacy-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  naver-privacy-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  naver-privacy-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  naver-privacy-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  naver-privacy-pp-cli sync --latest-only`,
