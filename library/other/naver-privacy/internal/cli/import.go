...
but do not stop the import.`,
  ...
  naver-privacy-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  naver-privacy-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | naver-privacy-pp-cli import <resource> --input -`,
